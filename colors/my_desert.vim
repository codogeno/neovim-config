...
hi IncSearch	cterm=bold ctermfg=0 ctermbg=39 guifg=slategrey guibg=khaki
"hi LineNr
hi ModeMsg	guifg=goldenrod
hi MoreMsg	guifg=SeaGreen
hi NonText	guifg=LightBlue guibg=grey10
hi Question	guifg=springgreen
hi Search	ctermbg=3 ctermfg=0 guibg=peru guifg=wheat
...
hi Constant	ctermfg=blue ctermfg=blue
